...
final List<ArtistModel> imageItems = [
  ArtistModel(
    imagePath: 'assets/icons/Rectangle 16.png',
    nameMusic: 'lilbubblegum',
    nameArtist: 'Billie Eilish',
  ),
  ArtistModel(
    imagePath: 'assets/icons/Rectangle 17.png',
    nameMusic: 'Happier Than Ever',
    nameArtist: 'Billie Eilish',
  ),
  ArtistModel(
    imagePath: 'assets/icons/Rectangle 16.png',
    nameMusic: 'dont smile at me',
    nameArtist: 'Billie Eilish',
  ),
];
        ...
        builder: (context, musicState) {
          if (musicState is LoadingMusic) {
            ...
            if (artistMusics.isEmpty) {
              return const Center(child: Text('هیچ آهنگی برای این آرتیست موجود نیست'));
            }
